...
# Environment local, develop, staging, uat , production
ENV= config('ENV')
...
# Installation Log: C:\Users\ccarulasan\AppData\Local\Temp\install-postgresql.log
...
# Configure logging directly in the script
import logging
